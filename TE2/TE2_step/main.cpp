...
int main(){
    ...
    int N,select;
    float t0, Y_0, step,tf,X_i,X_f,X_stp;
    string name;
    ...
    //cin >> N;
    cout << "Introduire l'abscise t desirée" << endl;
    cin >> t0;
    ...
    */ 
    ...
    for (int i = 0; i<t.size()-1; i++ ){
        ...
        if (select == 1) {
                ...
                Y_calc(i+1) = euler_progres(df_chosen, t(i), Y_calc(i), X(i) );
            ...
            if (select == 2) {
                ...
                Y_calc(i+1) = milieu(df_chosen, t(i), Y_calc(i), X(i) );
                Y_th(i) = f_chosen_th(t(i),t0,Y_0);
                Delta(i) = Y_calc(i) - Y_th(i) ;
                //cout << "Y_calc: \n" << Delta(i) << endl;
            ...
            if (select == 3){ 
                ...
                Y_calc(i+1) = rk4(df_chosen, t(i), Y_calc(i), X(i) );
                Y_th(i) = f_chosen_th(t(i),t0,Y_0);
                Delta(i) = Y_calc(i) - Y_th(i) ;
                //cout << "Y_calc: \n" << Delta(i) << endl;
            }
    ...
    ecrit(name, X, Y_calc, Y_th, Delta); 
    cout << "Ecrit !!!"<<endl;
